                ...
                <div class="card-body">
                    <form action="{{ route('order', $product->id) }}" method="POST" class="d-flex flex-column">
                        ...
                        <label class="form-label"> Nama Pelanggan
                            <input type="text" class="form-control" name="custName" required placeholder="Masukan nama pelanggan">
                        </label>
                        <label class="form-label"> Kontak/No.Telp
                            <input type="text" class="form-control" name="contact" required placeholder="Masukan kontak pelanggan">
                        </label>
                        <label class="form-label"> Paket Pilihan
                            <input type="text" class="form-control" name="package" disabled required value="{{ $product->name }}">
                        </label>
                        <label class="form-label"> Harga Paket
                            <input type="text" class="form-control" name="price" disabled required value="{{ $product->price }}">
                        </label>
