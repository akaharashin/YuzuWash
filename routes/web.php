...
Route::post('/payment/{orderList}', [TransactionController::class, 'payment'])->name('payment');
...
Route::post('/delete/{user}', [AdminController::class, 'deleteCashier'])->name('deleteCashier');
